...
# async baseline
momentum=0.99
python3 "${folder}/dnn_async_train.py" --dataset $dataset --world_size $world_size --model_accuracy --seed  --val --lr $lr --momentum $momentum --batch_size $batch_size --epochs $epochs --subfolder $subfolder_name
sleep 0.1
echo
